...
export default function CaseStudies() {
  return (
    <section id="casos" className="bg-cream-alt py-24 md:py-28">
      <div className="max-w-[1240px] mx-auto px-6 md:px-12">
        <ScrollReveal className="mb-12 md:mb-14">
          <h2 className="font-display font-normal text-[40px] mb-3.5">Cuentas que gestioné</h2>
          <p className="max-w-[520px] text-muted text-[15px] leading-[1.6]">
          ...
          {cases.map((c, i) => (
            ...
            >
              ...
              <div className="mt-3.5">
                ...
                <div className="text-[13px] text-muted-footer mt-0.5">{c.category}</div>
              </div>
            </motion.div>
          ))}
        </div>
